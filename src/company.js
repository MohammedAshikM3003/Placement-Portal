...
// Styles for the application status tags
const statusStyles = {
...
export default function Company({ onLogout, onViewChange, currentView }) {
  ...
  const renderContent = () => {
    switch (activeSubView) {
      case 'placed':
        return <PopUpPlaced onBack={handleBack} onViewChange={onViewChange} onLogout={onLogout} currentView="company" />;
      case 'pending':
        return <PopUpPending onBack={handleBack} onViewChange={onViewChange} onLogout={onLogout} currentView="company" />;
      case 'rejected':
        return <PopUpRejected onBack={handleBack} onViewChange={onViewChange} onLogout={onLogout} currentView="company" />;
      case 'list':
      default:
        return (
            <div className="dashboard-area" style={{paddingTop: '25px'}}>
                <div className="hubTitle" style={{ fontWeight: 800, fontSize: "25px", marginBottom: "24px", color: "#000000" }}>Company's Placement</div>
                <div className="placementHub" style={{ marginTop: "25px" }}>
                ...
                <div style={{ background: "#3B6FB6", borderRadius: "18px", padding: "32px 22px", marginTop: "25px" }}>
                  <div style={{ color: "#fff", fontWeight: 800, fontSize: "24px", marginBottom: "14px" }}>My Application History</div>
                  <div className="appList" style={{ overflowY: "auto", maxHeight: "370px", paddingRight: "4px" }}>
