/**
 * Coo_Calendar - Coordinator Themed Calendar Component
 *
 * A custom date picker component with coordinator theme colors (red).
 * Features:
      ...
      >
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              background: hoveredMonthBtn ? '#fce8e9' : '#fff', border: 'none', borderRadius: '8px',
          ...
          <button
            ...
            style={{
              background: hoveredYearBtn ? '#fce8e9' : '#fff', border: 'none', borderRadius: '8px',
              color: '#1a1a1a', fontWeight: 700, fontSize: '1rem',
              cursor: 'pointer', padding: '8px 14px',
              display: 'flex', alignItems: 'center', gap: '6px',
        ...
        <div style={{ height: '288px', overflow: 'hidden', position: 'relative' }}>
          ...
          {viewMode === 'month' ? (
            ...
            <div style={{ position: 'relative', height: '100%', display: 'flex' }}>
              ...
              >
                <style>{`.coo-year-list::-webkit-scrollbar{display:none}`}</style>
              ...
              {/* Custom scrollbar thumb - Coordinator Red */}
              <div style={{ width: '8px', background: '#fce8e9', borderRadius: '4px', margin: '6px 4px', position: 'relative', flexShrink: 0 }}>
                <div
                  ref={yearThumbRef}
                  onMouseDown={onYearThumbMouseDown}
                  style={{
                    position: 'absolute', left: 0, right: 0,
                    background: '#D23B42', borderRadius: '4px',
