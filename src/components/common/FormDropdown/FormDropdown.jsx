...
const FormDropdown = ({ 
  ...
  const themeColors = roleColors[role.toLowerCase()] || roleColors.coordinator;
  ...
  return (
    ...
    >
      <div
        className={`${styles['dropdown-header']} ${isOpen ? styles['dropdown-header-open'] : ''} ${disabled ? styles['dropdown-header-disabled'] : ''} ${headerClassName}`}
        onClick={handleToggle}
      >
        {displayLabel !== null ? (
          <span>{displayLabel}</span>
        ) : (
          <span className={styles['dropdown-placeholder']}>{placeholder}</span>
        )}
        {!disabled && (
          <svg
