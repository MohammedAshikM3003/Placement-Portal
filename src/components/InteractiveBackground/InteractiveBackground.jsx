...
const InteractiveBackground = () => {
  ...
  const testimonials = useMemo(() => [
    { name: 'Rahul S.', company: 'Google', batch: '2025', branch: 'CSE', text: 'Never imagined I\'d get into my dream company. This portal guided me through every step — from building my resume to cracking the final interview. Truly a game-changer for my career!', avatar: 'RS' },
    { name: 'Sneha R.', company: 'Microsoft', batch: '2025', branch: 'IT', text: 'From resume building to interview prep, everything was so seamless. The mock tests helped me identify my weak areas. I walked into my interview feeling confident and prepared.', avatar: 'SR' },
    { name: 'Arjun P.', company: 'Amazon', batch: '2024', branch: 'CSE', text: 'Got placed in my very first attempt thanks to the drive updates and notifications. The real-time alerts kept me on track. I never missed any opportunity that came my way.', avatar: 'AP' },
    { name: 'Divya M.', company: 'Infosys', batch: '2025', branch: 'IOT', text: 'The mock interviews and resources truly boosted my confidence. I practiced with peers and got instant feedback. This portal made placement season stress-free for me.', avatar: 'DM' },
    { name: 'Karthik V.', company: 'TCS', batch: '2024', branch: 'ECE', text: 'Received my offer letter within a week of applying. The streamlined process saved so much time. I could focus on preparation instead of paperwork and logistics.', avatar: 'KV' },
    { name: 'Ananya S.', company: 'Wipro', batch: '2025', branch: 'IT', text: 'This portal connected me with opportunities I didn\'t even know existed. The company profiles and past interview questions were incredibly helpful. Best placement resource ever!', avatar: 'AS' },
  ], []);
