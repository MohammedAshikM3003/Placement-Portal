...
export const CooRAFeedbackView = ({
  ...
  const color = {
    ...
    badgeText: '#862229',
    primary: '#D23B42',
    primaryShadow: 'rgba(210,59,66,0.3)',
    assessment: '#D23B42',
    focus: '#D23B42',
    focusRing: 'rgba(210,59,66,0.2)',
    thumb: '#D23B42'
  };
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginBottom: '14px' }}>
            ...
            <div style={{ display: 'flex', gap: '10px', alignItems: 'stretch', flexWrap: 'nowrap' }}>
              <div style={{ flex: '1 1 0', minWidth: 0 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px', border: '1px solid #f1c1c4', borderRadius: '8px', height: FIELD_HEIGHT, padding: '0 0.9rem', backgroundColor: '#fff7f7', fontSize: '0.84rem', lineHeight: 1.2, userSelect: 'none', boxSizing: 'border-box', width: '100%' }}>
                ...
                <div style={{ marginTop: '8px', display: 'flex', alignItems: 'center', gap: '8px', border: '1px solid #f1c1c4', borderRadius: '8px', height: FIELD_HEIGHT, padding: '0 0.9rem', backgroundColor: '#fff7f7', fontSize: '0.84rem', lineHeight: 1.2, userSelect: 'none', boxSizing: 'border-box', width: '100%' }}>
                  <span style={{ flex: 1, minWidth: 0, fontWeight: 600, color: '#1a1a1a', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
