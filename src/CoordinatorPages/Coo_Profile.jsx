...
import './Coo_Profile.module.css'; // Uses the user's original CSS file name
...
const SuccessPopup = ({ isOpen, onClose }) => {
    ...
    return (
        <div className="CoProfile-popup-overlay">
            <div className="CoProfile-popup-container">
                <div className="CoProfile-popup-header">Saved !</div>
                <div className="CoProfile-popup-body">
                    {/* SVG for the Animated Checkmark */}
                    <svg className="CoProfile-success-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 52 52" fill="none">
                        <circle className="CoProfile-success-icon--circle" cx="26" cy="26" r="25"/>
                        <path className="CoProfile-success-icon--check" d="M14.1 27.2l7.1 7.2 16.7-16.8" fill="none"/>
                    </svg>
                    <h2>Details Saved ✓</h2>
                    <p>Your Details have been</p>
                    <p>Successfully saved in the Portal</p>
                </div>
                <div className="CoProfile-popup-footer">
                    <button onClick={onClose} className="CoProfile-popup-close-btn">Close</button>
                </div>
            </div>
        </div>
    );
...
function CoProfile({ onLogout, currentView, onViewChange }) {
    ...
    // State for success popup visibility
