...
import './Coo_EligibleStudents.module.css';
...
const ExportProgressPopup = ({ isOpen, operation, progress, onClose }) => {
    ...
    return (
        <div className="co-es-export-popup-overlay">
            <div className="co-es-export-popup-container">
                <div className="co-es-export-popup-header">{operationText}</div>
                <div className="co-es-export-popup-body">
                    <div className="co-es-export-progress-circle">
                        ...
                        {/*<div className="co-es-export-progress-text">{progress}%</div>*/}
                    </div>
                    <h2 className="co-es-export-popup-title">{progressText} {progress}%</h2>
                    <p className="co-es-export-popup-message">
                        The Details have been {operation === 'excel' ? 'Exporting...' : 'Downloading...'}
                    </p>
                    <p className="co-es-export-popup-message">Please wait...</p>
                </div>
            </div>
        </div>
    );
...
const ExportSuccessPopup = ({ isOpen, operation, onClose }) => {
    ...
    return (
        <div className="co-es-export-popup-overlay">
            <div className="co-es-export-popup-container">
                <div className="co-es-export-popup-header">{headerText}</div>
                <div className="co-es-export-popup-body">
                    <div className="co-es-export-success-icon">
                    <svg xmlns='http://www.w3.org/2000/svg' viewBox="0 0 52 52" fill="none">
                        <circle className="co-es-success-icon--circle" cx="26" cy="26" r="25"/>
                        <path className="co-es-success-icon--check" d="M14.1 27.2l7.1 7.2 16.7-16.8" fill="none"
                            />
                        </svg>
                    </div>
                    <h2 className="co-es-export-popup-title">{title}</h2>
                    <p className="co-es-export-popup-message">{message}</p>
                </div>
                <div className="co-es-export-popup-footer">
                    <button onClick={onClose} className="co-es-export-popup-close-btn">Close</button>
                </div>
            </div>
        </div>
    );
    ...
    return (
        <div className="co-es-export-popup-overlay">
            <div className="co-es-export-popup-container">
                <div className="co-es-export-popup-header">{headerText}</div>
                <div className="co-es-export-popup-body">
                    <div className="co-es-export-failed-icon">
...
function CoEligiblestudents({ onLogout, currentView, onViewChange }) {
    ...
    const EyeIcon = () => (
        <svg className="co-es-profile-eye-icon" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <div className="co-es-dashboard-area">
                            <div className="co-es-summary-cards">
                                <div className="co-es-summary-card co-es-company-drive-card" >
                                    ...
                                    <div className="co-es-summary-card-desc-1" >Filter, sort and manage Student records</div>
                                </div>
                                ...
                                <div className="co-es-summary-card co-es-placed-students-card" onClick={() => handleCardClick('placed-students')} >
                                    <div className="co-es-summary-card-icon" style={{ background: '#ffffff', marginTop: 5 }}><img src={PlacedStudentsCap} alt="Placed Students" /></div>
                                    <div className="co-es-summary-card-title-2" style={{ marginTop: 35 }}>Placed Students</div>
                                    <div className="co-es-summary-card-desc-2" >Success gained through dedication daily</div>
                                </div>
                            </div>
                                    ...
                                    <div className="co-es-print-btn-container">
                                        ...
                                        {showDropdown && (
                                            <div className="co-es-dropdown-menu">
                                                {/* MODIFIED HANDLERS */}
                                                <div className="co-es-dropdown-item" onClick={handleExportToExcel}>Export to Excel</div>
                                                <div className="co-es-dropdown-item" onClick={handleExportToPDF}>Save as PDF</div>
                                            </div>
                                        )}
                                    </div>
                                </div>
