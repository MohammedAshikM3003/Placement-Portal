    ...
    return (
        <div className={styles.popupOverlay}>
            <div className={styles.popupContainer}>
                <div className={styles.popupHeader} style={{ backgroundColor: '#1976d2' }}>
                    Image Too Large!
                </div>
                <div className={styles.popupBody}>
                    <svg className={styles.imageErrorIcon} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 52 52">
                        <circle className={styles['imageErrorIcon--circle']} cx="26" cy="26" r="25" fill="none"/>
                        <g className={styles['imageErrorIcon--innerIcon']}>
                            {/* Simple image frame */}
                ...
                <div className={styles.popupFooter}>
                    <button onClick={onClose} className={styles.popupCloseBtn} style={{ backgroundColor: '#1976d2' }}>OK</button>
                </div>
            </div>
        </div>
    );
                ...
                <div className={styles.dashboardArea}>
                    <form ref={formRef} onSubmit={handleSave}>
                        ...
                        <div className={styles.profileSectionContainer}>
                            ...
                            <div className={styles.formGrid} style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '15px', alignItems: 'start' }}>
                                    ...
                                    <input type="text" name="overallCGPA" placeholder="Overall CGPA" defaultValue={studentData?.overallCGPA || ''} />
                                    <input type="text" name="clearedBacklogs" placeholder="No. of Backlogs (Cleared)" defaultValue={studentData?.clearedBacklogs || ''} />
                                    <input type="text" name="currentBacklogs" placeholder="No of Current Backlog (Arrear)" defaultValue={studentData?.currentBacklogs || ''} />
                                    <input type="text" name="yearOfGap" placeholder="Year of Gap" defaultValue={studentData?.yearOfGap || ''} />
                                    <input type="text" name="gapReason" placeholder="Reason for year of Gap" style={{ gridColumn: '1 / -1' }} defaultValue={studentData?.gapReason || ''} />
                            </div>
                        </div>
                        ...
                        <div className={styles.profileSectionContainer}>
                            ...
                            <div className={styles.formGrid}>
                                    ...
                                    <select
                                        name="companyTypes"
                                        value={studentData?.companyTypes || ''}
                                        onChange={(e) => setStudentData(prev => ({ ...prev, companyTypes: e.target.value }))}
                                    >
                                    ...
                                    <select
                                        ...
                                        onChange={(e) => setStudentData(prev => ({ ...prev, preferredJobLocation: e.target.value }))}
                                    >
