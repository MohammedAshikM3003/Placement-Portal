            ...
            if (resumeCacheRaw) {
              ...
              if (resumeCache?.resume && resumeCache.resume.fileData) {
                ...
                const cached = {
                  ...
                  resumeUploadDate: new Date(resumeCache.resume.uploadedAt).toLocaleDateString(),
      ...
      try {
        ...
        if (resumeFromComplete && resumeFromComplete.fileData) {
          const updatedData = {
            ...
            resumeUploadDate: new Date(resumeFromComplete.uploadedAt).toLocaleDateString(),
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', width: { xs: '100%', md: '30%' }, height: { xs: 'auto', md: '100%' } }}>
            ...
            >
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.25, width: '100%', flexGrow: 1, mb: 0.5, pl: 2 }}>
                 ...
                 <Box sx={{ display: 'flex', alignItems: 'center', width: '100%', gap: 1 }}><Typography variant="body1" color="#e3f2fd" fontSize="18px" sx={{ fontWeight: 'bold', minWidth: '80px' }}>Degree</Typography><Typography variant="body1" color="#e3f2fd" fontSize="18px" sx={{ fontWeight: 'bold', minWidth: '20px', textAlign: 'center' }}>:</Typography><Typography variant="body1" color="#e3f2fd" fontSize="18px" sx={{ fontWeight: 'bold', minWidth: '140px' }}>{studentData?.degree || 'N/A'}</Typography></Box>
            ...
            <Paper elevation={3} sx={{ width: '100%', height: '100%', p: 3, background: '#fff', borderRadius: '16px', boxShadow: '0 4px 12px rgba(0,0,0,0.08)', display: 'flex', flexDirection: 'column', border: '2px solid #c8c8c8', transition: 'border-color 0.3s ease', '&:hover': { borderColor: '#2085f6' } }}>
               ...
               <Box display="flex" flexDirection="column" alignItems="center" gap={2} sx={{ flex: 1, justifyContent: 'space-evenly' }}>
                 ...
                 <Box sx={{ textAlign: 'center', color: '#9e9e9e' }}>
                    ...
                    <Typography fontSize={15} mb={0.5} sx={{ lineHeight: 1.4 }}>*Click Upload and Select a file</Typography>
                    {uploadedFile && (
