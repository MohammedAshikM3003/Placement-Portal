  ...
  return (
    ...
    <div className={styles.container}>
      ...
      <div className={styles.main}>
        ...
        />
        {/* FIX: Converted className to styles.className */}
        <div className={styles['achievements-area']}>
          <AchievementsContent />
        </div>
      </div>
    </div>
        ...
        <div className={styles['achievements-filter-card']}>
          ...
          <div className={styles['filter-grid']}>
            ...
            <div className={styles['input-wrapper']}>
              <label htmlFor="competitionName" className={styles['static-label']}>Competition Name / Prize</label>
              <div className={styles['field-container']}>
                <input
                  type="text"
                  id="competitionName"
                  placeholder="Search Competition Name / Prize"
                  value={searchQuery}
                  onChange={handleSearchChange}
                  className={styles['filter-input-element']}
                />
              </div>
            </div>
            ...
            {/* Year Dropdown */}
            <div className={styles['input-wrapper']}>
              <label htmlFor="yearFilter" className={styles['static-label']}>Year</label>
              <Dropdown
                id="yearFilter"
                options={[
                  { label: 'I', value: 'I' },
                ...
                placeholder="Year"
                role="stu"
                className={styles['achievements-dropdown-wrapper']}
                headerClassName={styles['achievements-dropdown-header']}
              />
            </div>

            {/* Semester Dropdown */}
            <div className={styles['input-wrapper']}>
              <label htmlFor="semesterFilter" className={styles['static-label']}>Semester</label>
              <Dropdown
                id="semesterFilter"
                options={
                  yearFilter === 'I' ? [
                ...
                placeholder={yearFilter ? 'Semester' : 'Choose Year first'}
                disabled={!yearFilter}
                role="stu"
                className={styles['achievements-dropdown-wrapper']}
                headerClassName={styles['achievements-dropdown-header']}
            ...
            {/* Status Dropdown */}
            <div className={styles['input-wrapper']}>
              <label htmlFor="statusFilter" className={styles['static-label']}>Status</label>
              <Dropdown
                id="statusFilter"
                options={[
                ...
                selectedOption={statusFilter === 'all' ? '' : statusFilter}
