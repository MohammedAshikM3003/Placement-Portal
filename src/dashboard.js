...
const sidebarItems = [
  { icon: Adminicon, text: "Dashboard", view: "dashboard" },
  { icon: UploadResumeIcon, text: "Resume", view: "resume" },
  { icon: GroupIcon, text: "Attendance", view: "attendance" },
  { icon: teenyicons_certificate_outline, text: "Achievements", view: "achievements" },
  { icon: Adminicon, text: "Company", view: "company" },
  { icon: MyAccountIcon, text: "Profile", view: "profile" },
];
