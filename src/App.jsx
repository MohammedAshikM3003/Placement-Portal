...
const CoordinatorCompanyProfilePage = lazy(() => import("./CoordinatorPages/Coo_CompanyProfilePage.jsx"));
...
const CoordinatorSubjects = lazy(() => import("./CoordinatorPages/CooSubjects.jsx"));
...
function AppContent() {
  ...
  useEffect(() => {
    if (!authLoading) {
      ...
      const isPublicRoute = path === '/' || path === '/mainlogin' || path === '/signup' || path === '/registration' || path === '/registration-debug' || path === '/admin-excel-upload' || path === '/mail-status';
  ...
  return (
    ...
    <Routes>
      ...
      <Route path="/coo-company-profile/manage/view/:companyId" element={<RoleGuard allowedRoles={['coordinator']}><RouteErrorBoundary><Suspense fallback={<LoadingSpinner message="Loading..." showAnimatedDots={true} />}><CoordinatorCompanyProfilePage onLogout={handleStudentLogout} onViewChange={(view) => navigate(`/coo-${view}`)} /></Suspense></RouteErrorBoundary></RoleGuard>} />
      ...
      <Route path="/coo-subjects" element={<RoleGuard allowedRoles={['coordinator']}><RouteErrorBoundary><Suspense fallback={<LoadingSpinner message="Loading..." showAnimatedDots={true} />}><CoordinatorSubjects onLogout={handleStudentLogout} onViewChange={(view) => navigate(`/coo-${view}`)} /></Suspense></RouteErrorBoundary></RoleGuard>} />
      ...
      <Route path="/admin-eligible-students" element={<RoleGuard allowedRoles={['admin']}><RouteErrorBoundary><AdminEligiblestudents onLogout={() => navigate('/')} /></RouteErrorBoundary></RoleGuard>} />
      ...
      <Route path="/admin-student-application" element={<RoleGuard allowedRoles={['admin']}><RouteErrorBoundary><AdminEsstudapp onLogout={() => navigate('/')} /></RouteErrorBoundary></RoleGuard>} />
