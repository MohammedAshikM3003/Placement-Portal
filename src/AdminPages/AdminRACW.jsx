...
function AdminRACW() {
  ...
  // The filtering logic now depends only on the APPLIED filter states and status filter
  useEffect(() => {
        ...
        <div className={styles['Admin-racw-main-content']}>
          ...
          <div className={styles['Admin-racw-filter-box']}>
            ...
            <div className={styles['Admin-racw-tab-container']}>
              ...
              <div className={styles['Admin-racw-tab-inactive']}>Department wise <br/>Analysis</div>
            ...
            <div className={styles['Admin-racw-filter-inputs']}>
              <select className={styles['Admin-racw-filter-select']} value={companyFilter} onChange={(e) => setCompanyFilter(e.target.value)}>
                {uniqueCompanies.map(company => (<option key={company} value={company}>{company}</option>))}
              </select>
              <select className={styles['Admin-racw-filter-select']} value={batchFilter} onChange={(e) => setBatchFilter(e.target.value)}>
              ...
              <div className={styles['Admin-racw-table-body-scroll']}>
                <tbody>
                  ...
                  {filteredData.length === 0 && (
                    <tr>
                      <td colSpan="15" style={{ textAlign: 'center', padding: '40px 20px', width: '100%', display: 'block' }}>
