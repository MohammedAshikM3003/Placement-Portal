...
function AdminstudDB() {
    ...
    // Reset page to 1 when any filter query changes
    useEffect(() => {
        setCurrentPage(1);
        setSelectedStudentIds(new Set());
    }, [filterSearch, filterDept, filterBatch, filterSection, filterYear, filterSem]);
    ...
    }, [currentPage, filterSearch, filterDept, filterBatch, filterSection, filterYear, filterSem]);
