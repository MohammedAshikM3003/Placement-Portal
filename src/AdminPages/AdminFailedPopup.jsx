...
export const AdminFailedPopup = ({
  ...
  const color = {
    ...
    badgeText: '#555555',
    primary: '#797979',
    primaryShadow: 'rgba(121,121,121,0.3)',
    assessment: '#797979',
    focus: '#797979',
    focusRing: 'rgba(121,121,121,0.2)',
    thumb: '#797979'
  };
  ...
  const roundFailedCount = Array.isArray(window?.adminFeedbackData?.roundData?.students)
    ? window.adminFeedbackData.roundData.students.filter((student) => student?.status === 'Failed').length
    : NaN;

  const visibleIneligibleCount = String(
    resolveFirstCount(
      window?.adminFeedbackData?.failedStudentsCount,
