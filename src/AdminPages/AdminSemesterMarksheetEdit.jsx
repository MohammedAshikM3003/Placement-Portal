...
import useAdminAuth from '../utils/useAdminAuth.js';
...
const SEMESTER_CACHE_KEY = 'adminSemesterMarksheetState';
...
function AdminSemesterMarksheetEdit({ onLogout, onViewChange }) {
  useAdminAuth();
  ...
  const performSave = async () => {
    ...
    try {
      ...
      const endpoint = `${API_BASE_URL}/semester/update`;
...
export default AdminSemesterMarksheetEdit;
