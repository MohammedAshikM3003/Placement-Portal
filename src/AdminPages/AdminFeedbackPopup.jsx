                  ...
                  {isGenerating && (
                    <div style={{ position: 'absolute', inset: 0, background: 'rgba(240, 240, 240, 0.95)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', borderRadius: '10px', zIndex: 2 }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }}>
                        <div style={{ width: '16px', height: '16px', border: `2px solid ${color.focusRing || 'rgba(0,0,0,0.1)'}`, borderTop: `2px solid ${color.primary}`, borderRadius: '50%', animation: 'afpSpin 0.85s linear infinite' }} />
