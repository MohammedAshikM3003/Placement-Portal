                        ...
                        <form ref={formRef} onSubmit={handleSave} onChange={handleInputChange}>
                            ...
                            <div className="mr-profile-section-container" ref={sectionRefs.personal}>
                                ...
                                <div className="mr-form-grid">
                                    <div className="mr-personal-info-fields">
                                        ...
                                        <select defaultValue="" required><option value="" disabled >Degree *</option><option value="B.E">B.E</option><option value="B.Tech">B.Tech</option></select>
                                        ...
                                        <input type="email" placeholder="Primary Mail id *"required />
                                        <input type="email" placeholder="Domain Mail id *"required/>
                                ...
                                <div className="mr-form-grid" style={{ marginTop: '1.5rem' }}>
                                    <select defaultValue="" required><option value="" disabled >Community *</option> <option value="OC">OC</option><option value="BC">BC</option><option value="BCM">BCM</option><option value="MBC">MBC</option><option value="SC">SC</option><option value="SCA">SCA</option><option value="ST">ST</option></select>
                                    <input type="text" placeholder="Blood Group " />
                                    <input type="text" placeholder="Aadhaar Number *" required />
                                    <select defaultValue=""required><option value="" disabled>Medium of study *</option><option value="English">English</option><option value="Tamil">Tamil</option><option value="Other">Others</option></select>
                            ...
                            <div className="mr-profile-section-container" ref={sectionRefs.academic}>
                                ...
                                <div className="mr-form-grid">
                                    ...
                                    <input type="text" placeholder="10th Institution Name *" required/>
                                    <select defaultValue="" required><option value="" disabled>10th Board/University *</option><option value="State Board (Tamil Nadu)">State Board (Tamil Nadu)</option><option value="CBSE">CBSE</option><option value="ICSE">ICSE</option><option value="Other State Board">Other State Board</option></select>
                                    <input type="text" placeholder="10th Percentage *" required />
                                    <input type="text" placeholder="10th Year of Passing *" required />
                                    {(studyCategory === '12th' || studyCategory === 'both') && (
                                        <>
                                            <input type="text" placeholder="12th Institution Name *" required />
                                            <select defaultValue="" required><option value="" disabled>12th Board/University *</option><option value="State Board (Tamil Nadu)">State Board (Tamil Nadu)</option><option value="CBSE">CBSE</option><option value="ICSE">ICSE</option><option value="Other State Board">Other State Board</option></select>
                                            <input type="text" placeholder="12th Percentage *" required/>
                                            <input type="text" placeholder="12th Year of Passing *" required/>
                                            <input type="text" placeholder="12th Cut-off Marks *" required/>
                                        </>
                                    )}
                                    {(studyCategory === 'diploma' || studyCategory === 'both') && (
                                        <>
                                            <input type="text" placeholder="Diploma Institution *" required/>
                                            <input type="text" placeholder="Diploma Branch *" required />
                                            <input type="text" placeholder="Diploma Percentage *" required/>
                                            <input type="text" placeholder="Diploma Year of Passing *" required/>
                                        </>
                                    )}
                                </div>
                            </div>
                            ...
                            <div className="mr-profile-section-container" ref={sectionRefs.other}>
                                ...
                                <div className="mr-form-grid">
                                    <select defaultValue="" required><option value="" disabled >Residential status *</option><option value="Hosteller">Hosteller</option><option value="Dayscholar">Dayscholar</option></select>
                                    <select defaultValue="" required><option value="" disabled >Quota *</option><option value="Management">Management</option><option value="Counselling">Counselling</option></select>
                                    <input type="text" placeholder="Languages Known" />
                                    <select defaultValue="" required><option value="" disabled >First Graduate *</option><option value="Yes">Yes</option><option value="No">No</option></select>
                                    <input type="text" placeholder="Passport No." />
                                    <input type="text" placeholder="Skill set *" required/>
                                    <input type="text" placeholder="Value Added Courses" />
                                    <input type="text" placeholder="About sibling" />
                                    <input type="text" placeholder="Ration card No. *"required />
                                    <input type="text" placeholder="Family Annual Income *"required/>
                            ...
                            <div className="mr-profile-section-container" ref={sectionRefs.login}>
                                ...
                                <div className="mr-form-grid">
                                    ...
                                    <input type="password" placeholder="New Password (DOB dd-mm-yyyy) *" required/>
                                    <input type="password" placeholder="Confirm Password (DOB dd-mm-yyyy) *" required />
                                </div>
                            </div>
